...
async function loadSaved(container) {
  ...
  result.innerHTML = `
    <section class="data-grid">
      ...
      <div class="metric"><span>Version</span><b>V7.6.5</b></div>
    </section>
  ...
  container.innerHTML = `
    <section class="card">
      <div class="section-title">
        <div><h2>Portfolio Intelligence V7.6.5</h2><p>Read wallets, save labels, aggregate SLX exposure and export a portfolio snapshot.</p></div>
