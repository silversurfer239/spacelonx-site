  ...
  return `
    <section class="card">
      <div class="section-title">
        <div><h2>AI Memory V7.4.1</h2><p>Private local memory stored in this browser only. It keeps strategic briefs, project decisions and notes.</p></div>
        <span>LOCAL</span>
      </div>
      <div class="data-grid">
...
export function renderMemory(container) {
  const draw = () => {
    ...
    container.querySelector("#export-memory").addEventListener("click", () => downloadJSON("nenette-v7-4-1-memory.json", exportMemory()));
